            ...
            <div class="card text-center">
              <div class="card-header" style="background-color: #494444;">
                <ul class="nav nav-pills card-header-pills">
                  ...
                  <li class="nav-item" >
                    <a class="nav-link active" href="<?= BASEURL . "/login/register" ?>">Sign up</a>
                  </li>
                </ul>
              </div>
              <div class="card-body" style="background-color: gray; height: 390px; border-radius: 7px;">
               ...
               <form action="<?= BASEURL . '/login/daftar' ?>" method="post">
                ...
                <button type="submit" class="btn btn-primary" style="margin-top: 20px;" name="register">Register</button>
